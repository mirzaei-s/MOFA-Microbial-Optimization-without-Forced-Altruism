...
print(len(communitymodel.reactions))
print(len(communitymodel.metabolites))
...
biomass_id=['mpdel1biomass_species1','model2biomass525_species2'] 
...
model.Vbio_species1=pyo.Constraint(expr=model.v[biomass_id[0]]== 1.7923*1.160 )
model.Vbio_species2=pyo.Constraint(expr=model.v[biomass_id[1]]== 25.6102*9.313225746 )
...
print(value(model.v[biomass_id[0]]),'   ',value(model.v[biomass_id[1]]),'  ',  )
